...
Les tests réalisés sur les constructeurs ne sont pas très utiles car ils reviennent à tester les fonctionnalitées du langage java et non nôtre classe 
...
le paramètre expected viens de JUnit4 et n'est pas compatible avec ma version (JUnit5)
...
Il est un peu plus sûr que sans, mais cela ne fais pas foi. De plus les contructeurs basique n'ont pas forcément besoin d'être testé.
...
> Q.3a Expliquez en quoi il est impossible de tester en l’état cette opération.
	...
	Le coté random ne nous permet pas de prévoit le résultat attentu pour l'assertion.
