...
Si car cela revient à tester des opérations de bases fournies par java, et donc remettre en doute le langage lui-même en quelque sorte.
...
Non car il n'est pas possible de tester tous les cas possibles comme nous allons le voir dans la question suivante.
...
Etant donné l'état aléatoire des variables, on ne peut pas les prédire et donc on ne peut pas les tester.
