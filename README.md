...
>>> C'est étrange d'utiliser d'autre opération dans un test , cependant les 	accesseurs sont des opérations nécéssaires pour obtenir les valeurs d'un point car les attributs sont mis en "visibilité" privée pour plus de sécurité. Il est obligatoire de garder ces accesseurs mais comme ceux sont des opérations de base, il n'y a pas forcément besoin de les tester au préalable.
...
>>> Le code n'est pas sûr car tous les cas possibles ne sont pas testés. 
...
> Q.3a Expliquez en quoi il est impossible de tester en l’état cette opération.
    ...
    >>> On ne peut pas prédire le comportement de cette opération car les 			>>>arguments qui doivent lui être passés sont des nombres aléatoires. 			>>>C'est pour cela qu'il est nécéssaire d'utiliser Mockito pour tester 			>>>cette opération
