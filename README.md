...
## R�ponses aux questions (M1ICE Antoine Dupuy)

> Q.1b Il est n�cessaire de tester les op�rations avant de les utiliser dans de futurs tests. Ainsi, il nous faut tester au pr�alable les op�rations getX() et getY().

> Q.2b Le code ne peut pas �tre certifi� s�r m�me si il est couvert par au moins un test. En effet les tests ne nous montrent que la pr�sence de bug et non l'absence. Ils sont contraints par notre vision de ce que le code doit produire en terme de comportement et structure.

> Q.3a Il nous est impossible de tester ce qui pourrait nous �tre renvoyer par les fonctions de nextInt. Ainsi, il nous est n�cessaire de mocker les objets Random.