...
public class MyPoint {
	 ...
	 * 
	 * @param newX The new X coordinate. Must be valid (not equal Double.NaN),
	 ...
	 * 
	 * @param newY The new Y coordinate. Must be valid (not equal Double.NaN),
	 *             otherwise nothing is done.
	 */
	...
	public MyPoint horizontalSymmetry(final MyPoint origin) throws IllegalArgumentException {
		...
		return new MyPoint(x, 2d * origin.getX() - y);
	}
