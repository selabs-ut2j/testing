...
public class MyPoint 
{
	...
	{
		super();
		this.x = pt == null ? 0d : pt.x;
		this.y = pt == null ? 0d : pt.y;
	}
	...
	public MyPoint rotatePoint(final MyPoint gravityC, final double theta) 
	{
		...
		//if angle is not a number, return point not rotated
		if(Double.isNaN(theta)) return new MyPoint(this);
